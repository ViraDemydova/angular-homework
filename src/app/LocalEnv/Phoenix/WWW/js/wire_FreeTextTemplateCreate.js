...
function freeTextTemplateNameExists(templateName)
{
var co = RSExecute("/asp/rs_wire_checkFreeTextTemplateName.asp","js_FreeTextNameExist", templateName);
...
{
case "cancel":
frm.action = "/asp/wire_templatelist.asp";
frm.submit();
break;
case "save":
if (ValidateForm(frm))
{
if (freeTextTemplateNameExists(frm.rtxtTemplateName.value) == 'false')
{	
...
{
alert("Template '" + frm.rtxtTemplateName.value + "' exists and is active. Please choose another name.");
...
function validateNameKey()
{
var bFlag = true;
if (isAngleBracket() || isSlashKey() || isQuestionMarkKey() || isColonKey() || isVerticalBarKey() || isStarKey() || isDoubleQuoteKey())
bFlag = false;
return bFlag;
}
