...
{
openSaveTradePopUp("Add");
break;
}
frm.hidAction.value = "AddEq";
...
{
openSaveTradePopUp("Update");
break;
}	
defaultTotalClearance(frm);
...
function defaultTotalClearance(frm)
{
if ((frm.fltTotalClearance.value.length == 0) || frm.fltTotalClearance.value.match(/\s+/))
{
frm.fltTotalClearance.value = "0";
}
}
...
var elTradeTimeMi;
var elTradeTimeAmPm;
var elDefTradeTimeIndName;
var elHidTradeTimeHr;
var elHidTradeTimeMi;
var elHidTradeTimeAmPm;
onEntryTypeClicked();
if (getDocumentElement("hidNewTradeCount").value > 0)
DisplayPrevShortCvOrder(1);
}
...
function openComments(lPosition, dtTradeDate)
{
var dtTxtTradeDate = getDocumentElement("hidTradeDate"+lPosition);
if (dtTxtTradeDate)
dtTradeDate = dtTxtTradeDate.value;
var sUrl = "short_convering_trades_comments_popup.asp?Position="+lPosition+"&Date="+dtTradeDate+"";
var sStyle = "width=350,height=200,scrollbars=1,resizable=1";
openGeneralPopup( sUrl, '', sStyle );	
}
function openEditShortCoveringTrade(lTransId)
{
var sUrl = "short_covering_trades_edit_popup_eq.asp?TransId="+lTransId;
var sStyle = "width=800,height=200,scrollbars=1,resizable=1";
openGeneralPopup( sUrl, '', sStyle );	
}
...
for (nCount = 1; nCount < elHiddenCount.value; nCount++)
{
elHiddenDirtyF = getDocumentElement("hidDirtyF" + nCount);
if (elHiddenDirtyF.value == "1")
{
submitPage( document.frmMain,'UpdateEq') 
break;
}
}
}
...
elHiddenDirtyF = getDocumentElement("hidDirtyF" + nCount);
var elHiddenOtherT = getDocumentElement("hidOtherT" + nCount);
if (elHiddenDirtyF.value == "1" && elHiddenOtherT.value == "0")
{
...
var sStyle = "width=900,height=500,scrollbars=1,resizable=1";
openGeneralPopup( sUrl, '', sStyle );	
}
